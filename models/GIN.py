...
class GINNet(nn.Module):
    def __init__(self, input_dim, output_dim, model_args):
        ...
        self.prototype_class_identity = torch.zeros(self.num_prototypes,
                                                    output_dim).to(model_args.device)
    ...
    def forward(self, data, merge=False):
        ...
        node_features_1 = torch.nn.functional.relu(self.gnn_layers[0](x, edge_index)) # torch.Size([375, 128]) 
...
class GINTimeSeries(GINNet):
    """
    Generate a code for tic tac toe game
    """
    def __init__(self, input_dim, output_dim, model_args):
        super(GINNet, self).__init__()
        self.output_dim = output_dim
        ...
        self.fully_connected_1 = torch.nn.Linear(self.latent_dim[2], self.latent_dim[2])
        self.fully_connected_2 = nn.Conv2d(in_channels=self.latent_dim[2],
                                             out_channels=12,
                                             kernel_size=(1,1),
                                             bias=True)
